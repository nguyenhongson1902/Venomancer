...
def test(hlpr: Helper, epoch, backdoor=False, model=None, atkmodel=None):
    ...
    assert len(class_counts) in [15, 10, 200, 0], "The number of classes is not equal to 15 (chestxray) or 10 (mnist, cifar) or 200 (tinyimagenet) or 0 (no attack). The problem is due to randomly sampling negative labels"
