...
class Helper:
    ...
    def make_defense(self):
        ...
        try:
            ...
            raise ModuleNotFoundError(f'Your defense: {self.params.defense} should '
                                      f'be one of the follow: Krum, Weak_DP, Norm_Clipping, FLAME, Deepsight, \
    ...
    def save_model(self, model=None, tgtmodel=None, epoch=0, val_loss=0):
...
#         except (ModuleNotFoundError, AttributeError):
#             raise ModuleNotFoundError(f'Your attack: {self.params.attack} should '
#                                       f'be defined as Marksman in attacks/marksman.py')
#         self.attack = attack_class(self.params)
